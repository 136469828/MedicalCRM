...
@interface AreaViewController ()<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate>
...
- (void)viewDidLoad {
    [super viewDidLoad];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(closeCity:) name:@"cityBtn" object:nil];
...
- (void)closeCity:(NSNotification *)obj
{
    if (self.block)
    {
        self.block(obj.object);
    }
