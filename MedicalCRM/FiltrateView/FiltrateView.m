...
{
    [_completionArr removeAllObjects];
...
//        titleLab.adjustsFontSizeToFitWidth = YES;
        ...
        titleLab.frame = CGRectMake(ScreenWidth*0.15, 0, ScreenWidth/2-ScreenWidth*0.15, 43);
        [_titleLabArr addObject:titleLab];
        [bgView addSubview:titleLab];
        
        UIImageView *angleImgView = [[UIImageView alloc]initWithFrame:CGRectMake(titleLab.bounds.size.width +10 , 18, 13, 7)];
