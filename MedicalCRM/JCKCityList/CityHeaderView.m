...
//    [hotCSection addSubview:hcityLabel];
    ...
    for (int i = 0; i < textArr.count; i++) {
        ...
        [headerBtn addTarget:self action:@selector(clickBtn:) forControlEvents:UIControlEventTouchDown];
...
- (void)clickBtn:(UIButton *)btn
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"cityBtn" object:btn.titleLabel.text];
}
